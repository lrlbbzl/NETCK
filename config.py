...
parser.add_argument('--valid-path', default='./data/WN18RR/valid.txt.json', help='valid dataset path')
...
parser.add_argument('--batch-size', default=64, type=int, help='batch size in training')
...
parser.add_argument('--margin', default=0.0, type=float, help='additive margin for InfoNCE')
...
parser.add_argument('--loader-workers', default=1, type=int, help='number of workers when loading dataset')
